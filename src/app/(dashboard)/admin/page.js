...
<div className="grid grid-cols-8 gap-5 my-7">
    <div className="col-span-3  p-9 rounded-2xl bg-gradient-to-t from-[#060B28] to-[#0A0E23]">
    ...
    <div className="bg-[#060B26] col-span-2 p-5 rounded-2xl">adnan</div>
    <div className="col-span-3 bg-[#060B26] p-5 rounded-2xl">6</div>
</div>
